...
export declare const createStudy: (userId: string, data: CreateStudyDto) => Promise<{
    id: string;
    createdAt: Date;
    updatedAt: Date;
    userId: string;
...
export declare const getStudies: (userId: string) => Promise<{
    id: string;
    createdAt: Date;
    updatedAt: Date;
    userId: string;
...
export declare const getStudyById: (id: string, userId: string) => Promise<{
    id: string;
    createdAt: Date;
    updatedAt: Date;
    userId: string;
